...
export const sendMailActive = (emailTo, activeCode) => {
    ...
    const options = {
        ...
        subject: "Chào mừng bạn đến với RoomMaster - Phần mềm quản lý nhà cho thuê", // Tiêu đề của mail
...
export const sendMailRecovery = (emailTo, recoveryCode) => {
    ...
    const options = {
        from: process.env.EMAIL, // địa chỉ admin email bạn dùng để gửi
        to: emailTo, // địa chỉ gửi đến
        subject: "Lấy lại mật khẩu RoomMaster - Phần mềm quản lý nhà cho thuê", // Tiêu đề của mail
